...
- Uma licença pode ter N dispositivos (max_devices).
- Cliente ativa com /activate, depois valida token com /validate.
- Métricas de uso em /usage.
- Rotas admin protegidas por ADMIN_TOKEN (Bearer).
- Painel visual em /panel.
"""
...
# -------- LISTAGENS PÚBLICAS (usadas no painel) --------
      ...
      <main>
        ...
        <div class="table-wrapper">
          <table>
            ...
            <tbody id="usageBody">
              <tr><td colspan="9">Nenhum dado ainda. Clique em "Carregar dados".</td></tr>
            </tbody>
          </table>
        </div>
      </main>
